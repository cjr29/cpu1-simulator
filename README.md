...
CALL|02|00000010|MMMMMMMM MMMMMMMM|ABS|PC <- PC+3,SP <- SP-1;(SP) <- PC; Call subroutine, save PC on stack (Big Endian)
RET|03|00000011||IMP|PC.1 <- (SP),SP+1,PC.0 <- (SP), SP+1; Return from subroutine popping PC off stack (Big Endian)
